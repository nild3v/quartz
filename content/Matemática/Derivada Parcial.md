...
A derivada parcial é denotada como:

$\dfrac{\partial f}{\partial x}$ ou $\dfrac{\partial f}{\partial y}$
...
Porque a derivada de $x^2$ é $2x$ e considerados $y$ como uma constante no primeiro caso.

No segundo caso acontece o contrário, o $x$ é dado como uma constante e a derivada de $y^2$ é $2y$

Lembrando que a derivada de qualquer constante é sempre $0$

O símbolo $\partial$ é chamado de Partial
